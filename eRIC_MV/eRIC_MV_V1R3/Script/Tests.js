...
// add a comment
//Login
exestatus = Features.MvLogin(TestName,exestatus); /* Rajesh 24 Feb 2021 - comment started to debug*/
//Enter Patient Register
exestatus = Features.MvPatientRegister(TestName,exestatus); /* Rajesh 24 Feb 2021 - comment started to debug*/
...
//Enter Patient Demographics .... can stay commented
//exestatus = Features.MvPatientDemographics(TestName,exestatus);
...
//Enter Patient Register
exestatus = Features.MvPatientRegister(TestName,exestatus);
//Enter Patient Demographics - STAY COMMENTED
//exestatus = Features.MvPatientDemographics(TestName,exestatus);
...
//Enter Patient Demographics - not required ....can stay commented
//exestatus = Features.MvPatientDemographics(TestName,exestatus);
...
//Review Admission Summary- STAY COMMENTED
//exestatus = Features.MvAdmissionSummary(TestName,exestatus);
...
function APD_ValidationTab02(TestName)
{
    ...
    //Verify details in the ANZICS addin 
    exestatus = Features.MVVerifyANZICSDetailsTab02(TestName,exestatus);
...
function APD_ValidationTab03(TestName)
{
    ...
    // Enter data into ERIC for ANZICS Tab 3 
    exestatus = Features.MvEnterDataForANZICSTab3(TestName,exestatus);
    
    //Verify details in the ANZICS addin 
    exestatus = Features.MVVerifyANZICSDetailsTab03(TestName,exestatus);
...
function APD_ValidationTab04(TestName)
{
    ...
    exestatus = Features.MvEnterPathologyForANZICS(TestName,exestatus);
    
    exestatus = Features.MVVerifyANZICSDetailsTab04(TestName,exestatus);
...
// Flowsheet validation tMvViewPathologyo be checked
exestatus = Features.MvViewPathology(TestName,exestatus);
...
//Validation of ReviewMedicationList  - STAY COMMENTED
//exestatus = Features.MvPrescribeTopicalPatch(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20611
// Desc :Saved session should hold the saved value for Ticking options in AP3 Chronic Health Conditions ticks/unticks option/s in AP2 Chronic Health Conditions
// Owner : Rajesh Menghani
...
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20611(TestName)
{
    var exestatus = true;
    ...
    //Enter and Verify details in the ANZICS Tab 2
    exestatus = Features.MVVerifyANZICS_JIRA_20611(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20618
// Desc :Worst value for Map should be calculated away from the APD normal value range
// Owner : Rajesh Menghani
// Creation date:22 Dec 2020
// Update By :
// Update date:
...
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20618(TestName)
{
    var exestatus = true;
    ...
    //Enter and Verify details in the ANZICS Tab 3
    exestatus = Features.MVVerifyANZICS_JIRA_20618(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20603
// Desc :Patient Identifier / Statistical Key fileds should be disabled in ANZICS tab 1
// Owner : Rajesh Menghani
...
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20603(TestName)
{
    var exestatus = true;
    ...
    //Enter and Verify details in the ANZICS Tab 1
    exestatus = Features.MVVerifyANZICS_JIRA_20603(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20601
// Desc :ANZICS JIRA - High RR and Low RR collected while Invasilvely ventilated should be checked in TAB 3
// Owner : Rajesh Menghani
// Creation date:24 Dec 2020
// Update By :
// Update date:
// Update desc:
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20601(TestName)
{
    ...
    //Enter and Verify details of RR in the ANZICS Tab 3
    exestatus = Features.MVVerifyANZICS_JIRA_20601(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20600
// Desc :ANZICS JIRA - Checkbox of date of Birth on TAB 1 should be disabled
// Owner : Rajesh Menghani
// Creation date:24 Dec 2020
// Update By :
// Update date:
...
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20600(TestName)
{
    ...
    //Enter and Verify details of RR in the ANZICS Tab 3
    exestatus = Features.MVVerifyANZICS_JIRA_20600(TestName,exestatus);
...
//******************************************************************************************//
//******************************************************************************************//
// Name :ANZICS_JIRA20466
// Desc :ANZICS JIRA - Override Diagnosis Type checkbox should be displayed with correct choice of hospital admission source and ICU admission source
// Owner : Rajesh Menghani
...
//******************************************************************************************//
//******************************************************************************************//
function ANZICS_JIRA20466(TestName)
{
    ...
    //Enter and Verify details of RR in the ANZICS Tab 3
    exestatus = Features.MVVerifyANZICS_JIRA_20466(TestName,exestatus);

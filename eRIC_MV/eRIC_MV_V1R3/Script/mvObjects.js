...
//******************************************************************************************//
//******************************************************************************************//
function getObjectPropertyValue(searchProcess, findObject, findProperty, timeOut,exestatus)
{
...
//MANOJ MALI ; 11 NOV 2020 ADDED BELOW FUNCTION TO RANDOMLY SELECT VALUE FROM DROPDOWN.TO FIX TESTCASE CMP2_TC005
function ImdListBoxSelectionRandom(listSelectionObjectName, textSelection,exestatus) {
...
function scrollUntilVisible(objectToCheckVisible,exestatus) {
  ...
  var isVisible = aqObject.GetPropertyValue(objectToFind, "VisibleOnScreen");
...
//******************************************************************************************//
//******************************************************************************************//
// Name :enterEditText - Fullnametext
...
//******************************************************************************************//
//******************************************************************************************//
//Function to verify that the Object is visible on the screen
function isObjectVisible(objectToCheckVisible,exestatus)
{
    if (equal(exestatus,true))
    {
        // Get the metavison process
...
module.exports.ImdListBoxSelectionRandom = ImdListBoxSelectionRandom;
...
module.exports.isObjectVisible = isObjectVisible;
module.exports.getObjectPropertyValue = getObjectPropertyValue;

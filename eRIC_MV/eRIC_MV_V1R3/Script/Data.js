...
// To run in the VM Machine with old OS pls uncomment below
...
// To run in the VM Machine with old OS pls comment below
var strConn = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source = "+Project.Path +"..\\..\\eRIC_TestAutomation_Data.xls;Persist Security Info=False;Extended Properties=\"Excel 8.0;HDR=Yes;IMEX=1;\""
//var strConn = "Driver={Microsoft Excel Driver (*.xls, *.xlsx, *.xlsm, *.xlsb)};DBQ= "+Project.Path +"..\\..\\eRIC_TestAutomation_Data.xls;\""
cn.Open(strConn);
...
var cn = ADO.CreateConnection();
var strConn = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source = "+Project.Path +"..\\..\\eRIC_TestAutomation_Data.xls;Persist Security Info=False;Extended Properties=Excel 8.0;"
cn.Open(strConn);
var rs = ADO.CreateRecordset();
